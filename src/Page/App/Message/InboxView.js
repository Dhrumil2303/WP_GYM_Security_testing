...
import { fetchInboxviewmessagelist, inboxMessagesend, loadingStart } from "../../redux/actions/inboxMessage";
class InboxView extends Component {
    ...
    async replymessageList() {
        const { fetchInboxviewmessagelist, loadingStart } = this.props;
        loadingStart();
        ...
        fetchInboxviewmessagelist(inboxview)
    };


    async onSend(messages = []) {
        const { inboxMessagesend, loadingStart } = this.props;
        loadingStart();
...
const mapStateToProps = (state) => {
    return {
        ViewData: state.inboxMessage.inboxViewData,
        loading: state.inboxMessage.loading,
    };
};

const mapDispatchToProps = {
    fetchInboxviewmessagelist,
    inboxMessagesend,
    loadingStart
};

...
import { composeMessagesend, loadingStart, fetchMemberAndStaffAction } from "../../redux/actions/message";
class compose extends Component {
    ...
    render() {
        ...
        const { Membershipopen, Name, Message_Comment, Message_subject } = this.state;
        let staffList = [];
                    ...
                    <ScrollView>
                        ...
                        {Platform.OS == "android" ? (
                            <View style={styleCss.compose_view}>
                                <DropDownPicker
                                    ...
                                    listItemContainerStyle={{ backgroundColor: '#FCFBFB', borderColor: '#EBEBEB', borderWidth: 1, fontFamily: 'Poppins-Medium', }}
                                    conta
                                    listMode="SCROLLVIEW"
                                    scrollViewProps={{
                                    ...
                                    dropDownContainerStyle={{ zIndex: 50000, height: 120, borderColor: '#EBEBEB', borderWidth: 1 }}
                                    open={Membershipopen}
                                    value={Name}
                        ...
                        <Row style={styleCss.compose_subject_row}>
                            <TouchableOpacity style={styleCss.compose_subject_text}>
                                <TextInput style={styleCss.compose_subject_input}
                        ...
                        <Row style={styleCss.compose_row}>
                            <Text style={styleCss.compose_text}>{t("Message Comment")}: </Text>
                        </Row>

                        <Row style={styleCss.compose_message_row}>
                            <TouchableOpacity style={styleCss.compose_message_text}>
                                <Textarea style={styleCss.compose_message_input}
                        ...
                        <TouchableOpacity style={styleCss.compose_btn} onPress={this.sendmessage.bind(this)}>
                            <Row style={styleCss.compose_btn_container}>
                                <Text style={styleCss.compose_btn_text}>{t("Send Message")}</Text>
                            </Row>
                        </TouchableOpacity>
                    </ScrollView>

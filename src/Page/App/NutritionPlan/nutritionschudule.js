...
export default class nutritionschudule extends Component {
    ...
    componentDidMount() {
        const start = this.props.navigation.getParam('paramKey1');
        const Data = this.props.navigation.getParam('nurtitionData');
        const x = Object.entries(Data).map((item) => item);
    ...
    renderItem1 = ({ item }) => {
        return (
            ...
            <Row style={styleCss.nutritionschudule_details_row}>
                <Col style={styleCss.nutritionschudule_details_col}>
                    <Text style={styleCss.nutritionschudule_details_text}>{this.showString(item)[0]}</Text>
                </Col>
                <Col style={styleCss.nutritionschudule_details_col2}>
                    <Text style={styleCss.nutritionschudule_details_data}>:</Text>
                </Col>
                <Col style={styleCss.nutritionschudule_details_col}>
                    <Text style={styleCss.nutritionschudule_details_data}>{this.showString(item)[1].replace(" ", "")}</Text>
                </Col>
            </Row>
    ...
    renderItem = ({ item }) => {
        return (
            <ScrollView style={styleCss.container}>
                ...
                <Row style={styleCss.nutritionschudule_list_row}>
                    <Col>
                        <Row style={styleCss.nutritionschudule_row}>
                            <Text style={styleCss.nutritionschudule_list_text}>{item[0]}</Text>
                        </Row>
                        <FlatList
                            data={item[1]}
